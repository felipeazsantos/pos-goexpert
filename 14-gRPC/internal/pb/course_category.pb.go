...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id2\xd1\x02\n" +
	"\x0fCategoryService\x12A\n" +
	"\x0eCreateCategory\x12\x19.pb.CreateCategoryRequest\x1a\x14.pb.CategoryResponse\x12E\n" +
	...
	"\x0eListCategories\x12\t.pb.blank\x1a\x10.pb.CategoryList\x123\n" +
	"\vGetCategory\x12\x16.pb.CategoryGetRequest\x1a\f.pb.CategoryB\rZ\vinternal/pbb\x06proto3"
